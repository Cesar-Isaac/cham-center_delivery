...
import '../../../../features_user/authentication/domain/entities/user_entity.dart';
...
class DriverLocationPickerPage extends StatefulWidget {
  static const String route = '/driver-location-picker';

  const DriverLocationPickerPage({
    super.key,
    required this.draft,
  });
  ...
  @override
  State<DriverLocationPickerPage> createState() =>
      _DriverLocationPickerPageState();
}

class _DriverLocationPickerPageState
    extends State<DriverLocationPickerPage> {
  ...
  Future<void> _completeSignup() async {
    ...
    final UserEntity driver = UserEntity(
      ...
      vehiclePlate: widget.draft.vehiclePlate,
    );

    await context.read<AuthCubit>().signup(driver);
  }
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      ...
      builder: (context, state) {
        ...
        final bool isLoading =
            isSignupLoading || _isResolvingAddress;
