...
import '../../../auth/presentation/widgets/vehicle_type_dropdown.dart';

class DriverEditProfilePage extends StatefulWidget {
  static const String route = '/driver-edit-profile';

  const DriverEditProfilePage({super.key});

  @override
  State<DriverEditProfilePage> createState() =>
      _DriverEditProfilePageState();
}

class _DriverEditProfilePageState
    extends State<DriverEditProfilePage> {
  ...
  void initState() {
    ...
    _address = driver?.address ?? '';
    _latitude = driver?.latitude ?? 0;
    _longitude = driver?.longitude ?? 0;
  }
  ...
  Future<void> _saveProfile() async {
    ...
    final UserEntity updatedDriver =
    driver.copyWith(
